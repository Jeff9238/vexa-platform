...
// Removed ArrowLeft
import FilterSidebar, { FilterMobileTrigger } from "@/components/FilterSidebar"; // <--- IMPORT NEW COMPONENT
      ...
      <div className="sticky top-20 z-40 bg-[#0a0a0a]/95 backdrop-blur-xl border-b border-white/10 py-3 shadow-lg transition-all">
          <div className="max-w-[1920px] mx-auto px-6 flex items-center justify-between">
             ...
             <div className="flex items-baseline gap-3">
                <h1 className={`text-xl font-bold ${serifFont.className}`}>
                    {pageTitle}
                </h1>
                <div className="flex gap-2 text-[10px] text-gray-400 uppercase tracking-wider border-l border-white/20 pl-3">
                    {listingCategory && <span className="text-blue-400 font-bold">{listingCategory}</span>}
             ...
             {/* Right: Mobile Filter Button (Visible on Mobile, Hidden on Desktop) */}
